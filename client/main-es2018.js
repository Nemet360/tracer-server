...
const centerTA = [telAvivLng, telAvivLat];
const centerSF = [-122.48369693756104, 37.83381888486939];
const centerPT = [firstLon, firstLat];
const MAP_INITIAL = {
    container: 'map',
...
let MapComponent = class MapComponent {
    constructor(mapService, renderer2, store, http) {
        this.mapService = mapService;
        ...
        this.mySubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(5000).subscribe((x => {
            this.doStuff();
        }));
    }
    doStuff() {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].dataUrl).subscribe((data) => {
            //console.log(data); 
    ...
    addCurrentLocationButton() {
        const currLoc = new mapbox_gl__WEBPACK_IMPORTED_MODULE_2__["GeolocateControl"]({
            positionOptions: {
    ...
    focusCurrentLocation() {
        navigator.geolocation.getCurrentPosition((pos) => {
            const target = [pos.coords.longitude, pos.coords.latitude];
        ...
        markersData.forEach(marker => {
            ...
            marker.points.forEach(point => {
                if (point.lat && point.lon) {
                    ...
                    let markerObj = new mapbox_gl__WEBPACK_IMPORTED_MODULE_2__["Marker"](el);
